...
const OrderSummary = ({ subtotal, selectedSlot, children }) => {
  ...
  return (
    ...
    >
      <h2 className="text-base font-bold text-slate-900 mb-4 px-1 uppercase tracking-widest">
        Order Summary
      </h2>
      ...
      <div className="space-y-3 mb-6 flex-1">
        ...
        <div className="flex justify-between items-center text-sm px-1 pt-2">
          ...
          <span
            className={`font-bold transition-colors ${selectedSlot ? "text-green-600" : "text-slate-300"}`}
          >
            {selectedSlot
