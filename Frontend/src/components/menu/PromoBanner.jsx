            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              >
                {[
                  ...
                  <div key={idx} className="flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-1.5 sm:gap-3 px-2 sm:px-4 py-3 bg-slate-50 border border-slate-100 rounded-md text-slate-600 text-[9px] sm:text-[11px] font-bold uppercase tracking-wider shadow-sm text-center sm:text-left">
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative aspect-4/3 max-w-md mx-auto">
                ...
                >
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tight leading-none mb-1">Avg. Prep Time</p>
                    <p className="text-slate-900 font-extrabold text-sm leading-none">8 Minutes</p>
                  </div>
                </motion.div>
              </div>
            </div>
